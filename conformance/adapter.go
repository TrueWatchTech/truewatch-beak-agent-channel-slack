// Package slackconformance adapts the generated Slack SDK to the
...
// generated beakslack.Connector.
type adapter struct {
	conn sdk.Connector
	raw  beakslack.Connector
}

func newAdapter() *adapter {
	return &adapter{conn: beakslack.NewConnector(), raw: beakslack.Connector{}}
}
...
// fakeAuthClient stubs the Slack credential-validation endpoint so
